...
export default function Hero() {
    return (
        <section className='flex justify-between items-center lg:flex-row flex-col lg:flex-grow md:mb-0 mb-12'>
            <h2 className='md:text-2xl text-xl md:min-w-[550px] md:w-[550px] mx-auto px-6 mt-12 italic font-bold self-center justify-self-center tracking-tight text-gray-900"'>
